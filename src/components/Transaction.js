...
export const  Transaction = ({ transaction }) => {
  ...
  //eger amaount 0 dan kucuk ise $ in basinsa - ; buykse  + koy 
  ...
  return (
    <li className={transaction.amount < 0 ? "minus" : "plus"}>
      ...
      //gider der ki bu adam i burdan sitir edisin yeniye, kimligini kafasina kayder 
      //Context borusundan idyi deleteTransaction a gonderir 
      //ki o da GlolbalState in icindedir 
      */}
    </li>
  );
};
