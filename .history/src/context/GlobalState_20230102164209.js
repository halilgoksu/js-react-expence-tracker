...
//burdaki   function addTransaction(transaction){
 , AddTransactionda bulunan form dan olusturulan yeni eleman ile ayni sey 
//yeni eleman yani 
  ...
  //AddTransaction un ordan geliyorum , sana yeni bir eleman getirdim 
  //id si text i her seyi var 
  //vatandaslik ister kendileri 
  //AppReducer abimiz halleder o isi 
